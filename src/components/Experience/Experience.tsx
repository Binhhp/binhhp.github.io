                        ...
                        <VerticalTimeline>
                            {
                                MyInfoProvider.Experiences.slice(1, MyInfoProvider.Experiences.length).reverse().map((item, number) => (
                                    <VerticalTimelineElement
                                        ...
                                        date={item.date}
                                        iconStyle={{ background: `${item.background}`, color: `${item.background}` }}
                                        icon={<WorkingSVG />}>
                            ...
                            <VerticalTimelineElement
                                className="vertical-timeline-element--work"
                                contentStyle={{ background: `${MyInfoProvider.Experiences[0].background}`, color: `${MyInfoProvider.Experiences[0].color}` }}
                                contentArrowStyle={{ borderRight: `7px solid  ${MyInfoProvider.Experiences[0].background}` }}
                                date={MyInfoProvider.Experiences[0].date}
                                iconStyle={{ background: `${MyInfoProvider.Experiences[0].background}`, color: `${MyInfoProvider.Experiences[0].color}` }}
                                icon={<Bachelor />}>
                                <h3 className="vertical-timeline-element-title section--experience-title">Bachelor’s Degree</h3>
                                <p className="section--experience-subtitle">
                                    <strong>University:</strong>&nbsp;{MyInfoProvider.Experiences[0].title}
                                </p>
                                <p className="section--experience-subtitle">
                                    <strong>Faculty:</strong>&nbsp;{MyInfoProvider.Experiences[0].workPlace}
                                </p>
                                <p className="section--experience-subtitle">
                                    <strong>GPA:</strong>&nbsp;{MyInfoProvider.Experiences[0].technical}
                                </p>
                            </VerticalTimelineElement>
                            <VerticalTimelineElement
