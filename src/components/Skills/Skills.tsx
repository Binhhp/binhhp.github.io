...
export default function Skills() {
  return (
    <SkillWrapper id="skills" className="section section--skill">
            ...
            <div className="col-md-4">
              <div className="skill-box">
                <div className="description">
                  ...
                  <ul>
                    {MyInfoProvider.Skills.ProgramingLanguage.map((item) => (
                      <li>{item}</li>
                    ))}
                  </ul>
                  <h5>Platform &amp; Frameworks &amp; Libraries</h5>
                  <ul>
                    {MyInfoProvider.Skills.PlatformFrameworksLibraries.map(
                      (item) => (
                        <li>{item}</li>
                      )
                    )}
                ...
                <div className="image-container">
                  <div className="icon-skill object-icon">
                    <div
                      style={{ backgroundPosition: `0 -255px`, height: `99px` }}
                    ></div>
                  </div>
            ...
            <div className="col-md-4">
              <div className="skill-box">
                <div className="description">
                  <h5>Database</h5>
                  <ul>
                    {MyInfoProvider.Skills.Database.map((item) => (
                      <li>{item}</li>
                    ))}
                  </ul>
                  <h5>Version control</h5>
                  <ul>
                    {MyInfoProvider.Skills.VersionControl.map((item) => (
                      <li>{item}</li>
                    ))}
                  </ul>
                  <h5>IDEs</h5>
                  <ul>
                    {MyInfoProvider.Skills.IDEs.map((item) => (
                      <li>{item}</li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="col-md-4">
              <div className="skill-box">
                <div className="description">
                  <h5>Knowledge</h5>
                  <ul>
                    {MyInfoProvider.Skills.Knowledge.map((item) => (
                      <li>{item}</li>
                    ))}
                  </ul>
                </div>
